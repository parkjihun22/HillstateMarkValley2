...
const FloorPlan1 = () => {
	...
	<Helmet>
			...
			{/* SEO 최적화를 위한 메타 태그 */}
			<title>힐스테이트용인마크밸리 - 평면안내</title>
			<meta
			  name="description"
			  content="힐스테이트용인마크밸리의 평면도를 통해 세대별 구조와 공간 활용도를 확인하세요. 실용적이고 혁신적인 설계를 기반으로 한 다양한 평면 구성이 여러분의 생활을 더 편리하게 만듭니다.
												"
			/>
			<meta
			  name="keywords"
            ...
            <h1 className={styles.screenReaderOnly}>힐스테이트용인마크밸리 - 평면안내</h1>
			<p className={styles.screenReaderOnly}>59타입의평면 안내 페이지는 힐스테이트용인마크밸리의 각 아파트 평면도를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요.
			</p>
			...
			<img
				...
				src={page1}
				alt="힐스테이트용인마크밸리 59타입의평면안내-image1"
