  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>힐스테이트용인마크밸리 - 홍보영상</title>
        <meta
          name="description"
          content="힐스테이트용인마크밸리의 홍보영상을 통해 단지의 매력적인 디자인과 최신 편의시설을 생생하게 만나보세요. 현대적 감각과 고급스러움을 결합한 주거 환경, 평택의 중심에서 경험할 수 있는 새로운 라이프스타일을 영상으로 확인하세요."
        />
        <meta
          name="keywords"
          content="힐스테이트용인마크밸리"
      ...
      <p className={styles.screenReaderOnly}>
        힐스테이트용인마크밸리의 홍보영상을 통해 단지의 매력적인 디자인과 최신
